...
// 内存映射地址范围
`define ROM_BASE_ADDR       32'h00000000  // ROM起始地址
`define ROM_SIZE            32'h00010000  // ROM大小 64KB
`define ROM_ADDR_WIDTH      14           // ROM地址宽度 (2^14 * 4B = 64KB)

`define RAM_BASE_ADDR       32'h80000000  // RAM起始地址
`define RAM_SIZE            32'h00010000  // RAM大小 64KB
`define RAM_ADDR_WIDTH      14           // RAM地址宽度 (2^14 * 4B = 64KB)

`define IO_BASE_ADDR        32'hFFFF0000  // 外设起始地址
`define IO_SIZE             32'h00010000  // 外设大小 64KB
...
// 外设设备的高地址（用于地址译码，addr[31:16]部分）
`define IO_ADDR_HIGH    16'hFFFF  // 外设地址的高16位统一为0xFFFF

// 外设设备的地址（高六位，用于在IO区域内选择不同设备）
`define IO_SEVEN_DISPLAY 6'b000000  // 七段数码管   0xFFFFC000
`define IO_KEYBORAD 6'b000001       // 4*4键盘       0xFFFFC010
`define IO_COUNTER 6'b000010        // 计数器        0xFFFFC020
`define IO_PWM 6'b000011            // PWM控制器     0xFFFFC030
`define IO_UART 6'b000100           // UART串口      0xFFFFC040
`define IO_WATCH_DOG 6'b000101      // 看门狗        0xFFFFC050
`define IO_LED_LIGHT 6'b000110      // led灯         0xFFFFC060
`define IO_SWITCH 6'b000111         // 拨码开关      0xFFFFC070
`define IO_BUZZER 6'b010001         // 蜂鸣器        0xFFFFD110
