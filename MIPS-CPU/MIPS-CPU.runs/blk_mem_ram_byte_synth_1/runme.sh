...
HD_PWD='H:/MIPS-CPU/MIPS-CPU/MIPS-CPU.runs/blk_mem_ram_byte_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_ram_byte.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_ram_byte.tcl
