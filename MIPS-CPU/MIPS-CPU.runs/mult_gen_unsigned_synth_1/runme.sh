...
HD_PWD='H:/MIPS-CPU/MIPS-CPU/MIPS-CPU.runs/mult_gen_unsigned_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_gen_unsigned.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_gen_unsigned.tcl
